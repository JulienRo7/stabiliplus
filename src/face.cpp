...
#include "stabiliplus/edge.h" // Because of forward declaration
...
void Face::init() // this function needs to be called after creating a new face because shared_from_this cannot be used in the constructor.
{
...
void Face::finish() // this function needs to be called before destroying a face because shared_from_this cannot be used in the destructor.
{
